...
if (informationCourseElement && informationCourseValue) {
    ...
    forWhite = courseData.forWhite;
    console.log(forWhite)
...
async function startCourse() {
    ...
    if (response.ok) {
        ...
        console.log("white: " + forWhite)
        localStorage.setItem("forWhite", forWhite)
        if(forWhite == true){
            window.location.href = '../chessBoard/chessBoardFourCourse.html?courseTitle=' + pageTitle.innerText;
        }else{
            window.location.href = '../chessBoard/chessBoardFourCourseBlack.html?courseTitle=' + pageTitle.innerText;
        }
